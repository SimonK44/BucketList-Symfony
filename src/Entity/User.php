...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[Assert\Length(min: 3, max: 50, minMessage: 'The username is too short', maxMessage: 'The username is too long')]
    #[Assert\Regex(pattern: '/^[a-z0-9_-]+$/i', message: 'The username can only contain letters, numbers, and dashes')]
